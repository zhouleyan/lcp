...
const infra: Messages = {
  ...
  "host.ips": "IP Configuration",
  "host.ips.section": "Network Configuration",
  "host.ips.add": "Add IP",
  "host.ips.remove": "Remove",
  "host.ips.subnetId": "Subnet",
  "host.ips.ip": "IP Address (leave empty for auto)",
