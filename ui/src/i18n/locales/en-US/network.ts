...
const network: Messages = {
  ...
  "allocation.bound": "Bound",
  "allocation.unbound": "Unbound",
  "allocation.cannotDeleteBound": "This IP is bound to a host. Unbind it first before deleting.",
  ...
  "perm.group.network.networks.subnets": "Subnets",
  "perm.group.network.networks.subnets.allocations": "IP Allocations",
  ...
  "perm.network:networks:subnets:list": "List subnets",
  "perm.network:networks:subnets:get": "Get subnet details",
  "perm.network:networks:subnets:create": "Create subnet",
  "perm.network:networks:subnets:update": "Update subnet",
  "perm.network:networks:subnets:patch": "Patch subnet",
  "perm.network:networks:subnets:delete": "Delete subnet",
  "perm.network:networks:subnets:deleteCollection": "Batch delete subnets",
  "perm.network:networks:subnets:allocations:list": "List IP allocations",
  "perm.network:networks:subnets:allocations:create": "Allocate IP",
  "perm.network:networks:subnets:allocations:delete": "Release IP",
}
