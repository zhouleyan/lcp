    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "absolute left-2 top-2 size-7 bg-transparent p-0 opacity-50 hover:opacity-100"
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "absolute right-2 top-2 size-7 bg-transparent p-0 opacity-50 hover:opacity-100"
        ),
