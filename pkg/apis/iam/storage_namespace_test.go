...
func TestNamespaceStorage_Get(t *testing.T) {
	...
	storage := NewNamespaceStorage(nsStore, nil, nil)
...
func TestNamespaceStorage_Get_InvalidID(t *testing.T) {
	storage := NewNamespaceStorage(&mockNamespaceStore{}, nil, nil)
...
func TestNamespaceStorage_Create(t *testing.T) {
	...
	storage := NewNamespaceStorage(nsStore, wsStore, userStore)
