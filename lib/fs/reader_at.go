...
var (
	readCalls    = metrics.NewCounter(`lcp_fs_read_calls_total`)
	readBytes    = metrics.NewCounter(`lcp_fs_read_bytes_total`)
	readersCount = metrics.NewCounter(`lcp_fs_readers`)
)
...
var mmappedFiles = metrics.NewCounter("lcp_mmapped_files")
