...
var (
	readDuration      = metrics.NewFloatCounter(`lcp_filestream_read_duration_seconds_total`)
	readCallsBuffered = metrics.NewCounter(`lcp_filestream_buffered_read_calls_total`)
	readCallsReal     = metrics.NewCounter(`lcp_filestream_real_read_calls_total`)
	readBytesBuffered = metrics.NewCounter(`lcp_filestream_buffered_read_bytes_total`)
	readBytesReal     = metrics.NewCounter(`lcp_filestream_real_read_bytes_total`)
	readersCount      = metrics.NewCounter(`lcp_filestream_readers`)
)
...
var (
	writeDuration        = metrics.NewFloatCounter(`lcp_filestream_write_duration_seconds_total`)
	writeCallsBuffered   = metrics.NewCounter(`lcp_filestream_buffered_write_calls_total`)
	writeCallsReal       = metrics.NewCounter(`lcp_filestream_real_write_calls_total`)
	writtenBytesBuffered = metrics.NewCounter(`lcp_filestream_buffered_written_bytes_total`)
	writtenBytesReal     = metrics.NewCounter(`lcp_filestream_real_written_bytes_total`)
	writersCount         = metrics.NewCounter(`lcp_filestream_writers`)
)
